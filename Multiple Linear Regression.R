...
fitted(fit2) #Predicted value of Price for each value of promotion and sales
omni$sales
residuals(fit2)
...
summary(fit2)
head(omni)
cbind(omni, predict(fit2),newdata = data.frame(omni$price,omni$promotion)) #Prediction of Values
